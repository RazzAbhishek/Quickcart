...
//                 className="p-3 w-full text-sm border-t border-l border-b border-r border-gray-300 rounded-l-md 
//                 focus:outline-none focus:ring-2 focus:ring-gray-500 transition-all" required />
//                 <button type="submit" className= "bg-black text-white py-3 px-6 text-sm rounded-r-md hover:bg-gray-800 transition-all" >
