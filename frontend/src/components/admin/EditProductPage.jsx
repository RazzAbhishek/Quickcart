    ...
    <div className="max-w-5xl mx-auto p-6 shadow-md rounded-md">
        ...
        {/* Name */}
          <div className="mb-6">
           ...
           className="w-full border border-gray-300 focus:outline-none focus:ring-2 
           focus:ring-blue-500 rounded-md p-2" 
           required/>
         </div>
        {/* Description */}
        <div className="mb-6">
         ...
         <div className="mb-6">
            ...
            <div className="flex gap-4 mt-4">
                {productData.images.map((images,index)=> (
                    <div key = {index}>
                        <img src={images.urls} alt={images.altText} 
                        className="w-20 h-20 object-cover rounded-md shadow-md"/>
                    </div>
                ))}
            </div>
         </div>
         <button type="submit" className="w-full bg-green-500 text-white py-2 rounded-md hover:bg-green-600 transsition-colors">
            Upload Image
         </button>
       </form> 
    </div>
